            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <inertia-link class="mr-5 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-7 rounded-lg" :href="route('tests')" tabindex="-1">
                                Go back
                        </inertia-link>
                    ...
                    <table class="w-full whitespace-nowrap">
                        <tr class="text-left font-bold">
                            <th class="px-6 pt-6 pb-4"><label for="name">Test name:</label></th>
                            ...
                            <th class="px-6 pt-6 pb-4"><label for="body">Test Subject:</label></th>
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.post('/tests/store', this.form)
        },
    },
}
</script>
